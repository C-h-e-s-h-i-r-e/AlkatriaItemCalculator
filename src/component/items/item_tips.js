...
export default function Tips(props) {
    ...
    att_stat.setAttribute("class", "attack")
    att.innerText = "Atak: "
    att_stat.innerText = att_calc(props.rarity, props.prof, props.lvl, props.ratio, props.origin, props.part)
    att.append(att_stat)
    ...
    int_stat.setAttribute("class", "intelligence")
    int.innerText = "Inteligencja: "
    int_stat.innerText = int_calc(props.rarity, props.prof, props.lvl, props.ratio, props.origin, props.part)
    int.append(int_stat)
    ...
    def_stat.setAttribute("class", "deffence")
    def.innerText = "Obrona: "
    def_stat.innerText = def_calc(props.rarity, props.prof, props.lvl, props.ratio, props.origin, props.part)
    def.append(def_stat)
    ...
    as_stat.setAttribute("class", "attack_speed")
    ...
    ct_stat.setAttribute("class", "crit")
    ...
    ls_stat.setAttribute("class", "life_steal")
    ...
    fr_stat.setAttribute("class", "fire")
    ...
    wr_stat.setAttribute("class", "water")
    ...
    wir_stat.setAttribute("class", "wind")
    ...
    er_stat.setAttribute("class", "earth")
    ...
    hp_stat.setAttribute("class", "hp")
    hp.innerText = "Dodatkowe życie: "
    hp_stat.innerText = (hp_calc(props.rarity, props.prof, props.lvl, props.origin, props.part) / 2).toFixed(0)*2
    hp.append(hp_stat)
