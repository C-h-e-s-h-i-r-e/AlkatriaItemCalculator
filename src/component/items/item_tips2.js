...
export default function Tips(props) {
    ...
    att_stat.setAttribute("class", "attack2")
    att.innerText = "Atak: "
    ...
    int_stat.setAttribute("class", "intelligence2")
    ...
    def_stat.setAttribute("class", "deffence2")
    ...
    as_stat.setAttribute("class", "attack_speed2")
    ...
    ct_stat.setAttribute("class", "crit2")
    ...
    ls_stat.setAttribute("class", "life_steal2")
    ...
    fr_stat.setAttribute("class", "fire2")
    ...
    wr_stat.setAttribute("class", "water2")
    ...
    wir_stat.setAttribute("class", "wind2")
    ...
    er_stat.setAttribute("class", "earth2")
    ...
    hp_stat.setAttribute("class", "hp2")
